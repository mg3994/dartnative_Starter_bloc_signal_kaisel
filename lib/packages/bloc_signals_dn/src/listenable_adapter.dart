...
class ListenableBlocSignal<T> extends CubitSignal<T> {
  /// Creates a [ListenableBlocSignal] wrapping a DartNative [listenable] with
  ...
  /// The underlying DartNative [Listenable].
...
/// Extension methods on DartNative [Listenable] for [BlocSignalBase] conversion.
...
/// Extension methods on DartNative [ValueListenable] for [BlocSignalBase]
/// conversion.
...
extension BlocSignalValueListenableX<T> on BlocSignalBase<T> {
  /// Exposes this [BlocSignalBase] state container as a DartNative
  /// [ValueListenable].
  ///
  /// Example:
  /// ```dart
